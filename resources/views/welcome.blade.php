<x-user-layout>
    ...
    <section class="hero-section">
        <div class="hero-slider owl-carousel">
            <div class="hs-item set-bg" data-setbg="{{ asset('user_assets/img/hero-slider/1.jpg') }}">
                <div class="hs-text">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8">
            ...
            <div class="hs-item set-bg" data-setbg="{{ asset('user_assets/img/hero-slider/2.jpg') }}">
                <div class="hs-text">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 service-item">
                    <div class="service-icon">
                        <img src="{{ asset('user_assets/img/services-icons/1.png') }}" alt="1">
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 service-item">
                    <div class="service-icon">
                        <img src="{{ asset('user_assets/img/services-icons/2.png') }}" alt="1">
                    </div>
                    <div class="service-content">
                ...
                <div class="col-lg-4 col-sm-6 service-item">
                    <div class="service-icon">
                        <img src="{{ asset('user_assets/img/services-icons/3.png') }}" alt="1">
                    </div>
                    <div class="service-content">
                        <h4>Activity Hub</h4>
                        <p>Lorem ipsum dolor sitdo amet, consectetur dont adipis elit. Vivamus interdum ultrices augue.
                ...
                <div class="col-lg-4 col-sm-6 service-item">
                    <div class="service-icon">
                        <img src="{{ asset('user_assets/img/services-icons/4.png') }}" alt="1">
                    </div>
                    <div class="service-content">
                ...
                <div class="col-lg-4 col-sm-6 service-item">
                    <div class="service-icon">
                        <img src="{{ asset('user_assets/img/services-icons/5.png') }}" alt="1">
                    </div>
                    <div class="service-content">
                ...
                <div class="col-lg-4 col-sm-6 service-item">
                    <div class="service-icon">
                        <img src="{{ asset('user_assets/img/services-icons/6.png') }}" alt="1">
                    </div>
                    <div class="service-content">
                        <h4>Chemistry Lab</h4>
                        <p>Lorem ipsum dolor sitdo amet, consectetur dont adipis elit. Vivamus interdum ultrices augue.
    ...
    <!-- Enroll section -->
    <section class="enroll-section spad set-bg" data-setbg="{{ asset('user_assets/img/enroll-bg.jpg') }}">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                ...
                <div class="col-lg-6 offset-lg-1 p-lg-0 p-4">
                    <img src="{{ asset('user_assets/img/encroll-img.jpg') }}" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 course-item">
                    <div class="course-thumb">
                        <img src="{{ asset('user_assets/img/course/1.jpg') }}" alt="">
            ...
            <div class="row">
                <div class="col-md-6 event-item">
                    <div class="event-thumb">
                        <img src="{{ asset('user_assets/img/event/1.jpg') }}" alt="">
                    ...
                    <div class="event-info">
                        ...
                        <p><i class="fa fa-calendar-o"></i> 08:00 AM - 10:00 AM <i class="fa fa-map-marker"></i>
                            Center Building, Block A</p>
                        <a href="" class="event-readmore">REGISTER <i
                                class="fa fa-angle-double-right"></i></a>
                    </div>
                </div>
                <div class="col-md-6 event-item">
                    <div class="event-thumb">
                        <img src="{{ asset('user_assets/img/event/2.jpg') }}" alt="">
                        <div class="event-date">
    ...
    <section class="blog-section spad">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="blog-item">
                        <div class="blog-thumb set-bg" data-setbg="{{ asset('user_assets/img/blog/1.jpg') }}"></div>
