            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-3 footer-widget">
                    <div class="about-widget">
                        <img src="{{ asset('user_assets/img/logo-light.png') }}" alt="">
        ...
        <div class="copyright">
            <div class="container">
                <p>
                    ...
                    </script> All rights reserved Sher-E-Banlga Hall, BUET | This website is developed by <a href="https://www.facebook.com/monzurul.islam1112/" target="_blank">Monzurul ISLAM</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
            </div>
        </div>
