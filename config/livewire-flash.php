...
return [
    ...
    'styles' => [
        'info' => [
            'bg-color'     => 'bg-blue-100 alert alert-info',
        ...
        'success' => [
            'bg-color'     => 'bg-green-100 alert alert-success',
        ...
        'warning' => [
            'bg-color'     => 'bg-yellow-100 alert alert-warning',
        ...
        'error' => [
            'bg-color'     => 'bg-red-100 alert alert-danger',
